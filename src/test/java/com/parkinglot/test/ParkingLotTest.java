...
public class ParkingLotTest {
    ...
    public void givenCarAndUser_WhenPark_ShouldPark() {
        try {
            parkingLots.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle1"));
    ...
    public void givenCarToPark_WhenAlreadyParked_ShouldThrowException() {
        try {
            parkingLots.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle1"));
            parkingLots.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle2"));
        } catch (ParkingLotException e) {
            System.out.println(e.getMessage());
    ...
    public void givenParkingLot_WhenFull_ShouldThrowException() {
        try {
            parkingLots.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle1"));
            parkingLots.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle2"));
            parkingLots.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle3"));
            parkingLots.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle4"));
        } catch (ParkingLotException e) {
            System.out.println(e.getMessage());
    ...
    public void givenVehicle_WhenParkedEvenly_ShouldReturnVehicleSlot() {
        ...
        try {
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle1"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle2"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle3"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle4"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle5"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle6"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle7"));
    ...
    public void givenDriver_WhenDriverIsHandicap_ShouldReturnVehicleSlot() {
        ...
        try {
            ...
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle3"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle4"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.HANDICAP, "vehicle5"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.HANDICAP, "vehicle6"));
    ...
    public void givenParkingLot_WhenLargeVehicleComes_ShouldParkInGivenSlot() {
        ...
        try {
            ...
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle3"));
            parkingService.park(new VehicleDetails(Vehicle.SMALL, DriverType.NORMAL, "vehicle4"));
            parkingService.park(new VehicleDetails(Vehicle.LARGE, DriverType.NORMAL, "vehicle5"));
            parkingService.park(new VehicleDetails(Vehicle.LARGE, DriverType.NORMAL, "vehicle6"));
            parkingService.unPark("vehicle4");
            parkingService.park(new VehicleDetails(Vehicle.LARGE, DriverType.NORMAL, "vehicle7"));
